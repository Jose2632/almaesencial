  ...
  <div class="container" data-aos="fade-up">
   <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
    <div class="col-10 col-sm-8 col-lg-6">
      <img src="src/img/img04.jpeg" class="d-block mx-lg-auto img-fluid rounded flotante" alt="imagen, acerca de mi" width="700" height="500" loading="lazy">
    </div>
    <div class="col-lg-6">
      <h1 class="display-5 fw-bold lh-1 mb-3">Aprende más sobre mi</h1>
      <p class="lead">Mi nombre es Luna Esmeralda, y realizo amarres de Alta Magia para hacer volver a tu ser querido a tu lado. Podemos utilizar todo tipo de magia para ayudarte a conseguir lo que tanto anhelas.</p>
      <p class="lead">
      Mis Amarres de amor te ayudarán a dominar y someter a tu pareja. Consúltame ahora para ayudarte con tu problema de amor o de pareja.</p>
      <p class="lead">
      Pondré todos mis años de experiencia como vidente, conocimientos en amarres y rituales de amor junto a mi asesoría personalizada, para ayudarte a encontrar esa paz y felicidad que tanto anhelas.</p>
    </div>
  </div>
</div>
<br>
